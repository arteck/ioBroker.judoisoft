 ...
 * @param {string} hexString
 * @return {string} The decoded software version in the format "major.minor[patch]", where patch can be a number or a letter suffix.
 */
 ...
 * @param {number} year
 * @return {string} The formatted year as a hex string to use in /api/rest/FE00<formattedYear>
 */
 ...
 * @param {string} hexString
 * @return {object|null} An object containing the decoded yearly statistics, or null.
 */
 ...
 * @return {number} The decoded total water amount (in m^3), or -1 if the input is invalid.
 */
 ...
 * @param {string} hexString
 * @return {number|null} the timestamp in milliseconds, or null if the input is invalid.
 */
 ...
 * @param {string} hexString
 * @return {object|null} An object containing the decoded status data, or null if the input is invalid.
 */
 ...
 * @param {string} hexString
 * @return {object} The decoded dosage, or null if the input is invalid.
 */
