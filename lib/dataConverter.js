...
/**
 * Maps a cloud register entry to a decoded value.
 *
 * @param {Record<string, {data: string}>} deviceData - Cloud payload grouped by register index.
 * @param {string|number} indexIn - Register index or composite index like `790_8`.
 * @returns {string|number|null} Decoded register value, depending on register type.
 */
